...
namespace WeatherView.Service
{
    ...
    public class _0H00
    {
        ...
        public string TMP2m { get; set; }
        public string DPT2m { get; set; }
        public string WNDCHILL2m { get; set; }
        public string HUMIDEX { get; set; }
        public string RH2m { get; set; }
        public string PRMSL { get; set; }
        public string APCPsfc { get; set; }
        public string WNDSPD10m { get; set; }
        public string WNDGUST10m { get; set; }
        public string WNDDIR10m { get; set; }
    ...
    public class CurrentCondition
    {
        ...
        public string wnd_spd { get; set; }
        public string wnd_gust { get; set; }
    ...
    public class APIManager
    {
        ...
        public string GetForecastForHour(int hour)
        {
